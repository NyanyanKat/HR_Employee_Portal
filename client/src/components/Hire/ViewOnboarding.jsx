...
export default function ViewOnboarding() {
  ...
  const comfirmHandler = () => {
    const textAreaContent =
      feedbackRef.current.resizableTextArea.textArea.value;
        ...
        <>
          <PageHeader
            ...
            tags={
              <Tag
                color={
                  userInfo.userID.onboardingStatus === "pending"
                    ? "blue"
                    : userInfo.userID.onboardingStatus === "rejected"
                    ? "red"
                    : "green"
                }
              >
                {userInfo.userID.onboardingStatus}
              </Tag>
            }
            extra={
              userInfo.userID.onboardingStatus === "pending" && [
                <Button key="1" type="primary" onClick={approvHandler}>
                  Approve
                </Button>,
                <Button key="2" onClick={rejectHandler}>
                  Reject
                </Button>,
              ]
            }
                ...
                <TabPane tab="About Employee" key="1">
                  ...
                  >
                    ...
                    <Descriptions.Item label="License?">
                      <Checkbox
                        defaultChecked={userInfo.license ? true : false}
                        disabled
                      >
                        Yes
                      </Checkbox>
                      <Checkbox
                        defaultChecked={userInfo.license ? false : true}
                        disabled
                      >
                        No
                      </Checkbox>
                    ...
                    {userInfo.license && (
                      <>
                        <Descriptions.Item label="License Number">
                          {userInfo.license.number}
                        </Descriptions.Item>
                        <Descriptions.Item label="License Expiration Date">
                          {userInfo.license.expiration}
                        </Descriptions.Item>
                      </>
                    )}
                  </Descriptions>
                  ...
                  >
                    <Descriptions.Item label="Cell Phone Number" span="2">
                      {userInfo.cellphone}
                    </Descriptions.Item>
                    <Descriptions.Item label="Work Phone Number" span="2">
                      {userInfo.workphone}
                    </Descriptions.Item>
                  </Descriptions>
                  ...
                  >
                    {userInfo.citizenship.citizen ? (
                      ...
                      >
                        <Checkbox
                          defaultChecked={
                            userInfo.citizenship.status === "Citizen"
                              ? true
                              : false
                          }
                          disabled
                        ...
                        <Checkbox
                          defaultChecked={
                            userInfo.citizenship.status === "Green Card"
                              ? true
                              : false
                          }
                          disabled
                ...
                <TabPane tab="Documents" key="3">
                  ...
                  <Collapse defaultActiveKey={["1"]} onChange={onChange}>
                    <Panel header="Profile Picture" key="1">
                      <img
                        src={`http://localhost:3001/${userInfo.profile}`}
                    ...
                    {userInfo.license && (
                      <Panel header="Driver's License" key="2">
                        <img
                          src={`http://localhost:3001/${userInfo.license.photo}`}
                          alt="license copy"
                          style={{ height: 245, width: 400 }}
                        />
                      </Panel>
                    )}
                    {!userInfo.citizenship.citizen && (
                      <Panel header="OPT Receipt" key="3">
                        ...
                        <object
                          width="80%"
                          height="400"
                          data={`http://localhost:3001/${userInfo.citizenship.optReceipt}`}
